...
distiller_filter (marker_t *input, int N)
{
   ...
   double c0_r0[3] = {0, 1.0, 1.0};
    double c0_axis[3] = {1, 0, 0};
    double c0_R = 0.20000000000000001;
    double c1_r0[3] = {1.0, 1.0, 1.0};
    double c1_axis[3] = {-0.76604444311897801, 0.64278760968653925, 0};
    double c1_R = 0.20000000000000001;
    double p0_r0[3] = {1.0469846310392954, 0.98289899283371651, 1.0};
    double p0_n[3] = {-0.93969262078590843, 0.34202014332566871, 0};;
   ...
   for (int i = 0 ; i < N ; ++i) {
      ...
      int c0 = is_in_cylinder (p, c0_r0, c0_axis, c0_R);
        int c1 = is_in_cylinder (p, c1_r0, c1_axis, c1_R);
        int p0 = is_under_plane (p, p0_r0, p0_n);
        int good_marker = ((c0 || c1) && !p0);;
