...
COMMON = -Isource -std=c99 -DLINUX -pipe $(TESTS) -DACTIVATE_TRACER=1
...
.PHONY: distiller
distiller: o/distiller.out o/distiller2vtk.out o/tracer2vtk.out o/mark_trajectory.out
...
# [megamake] [project] (root: source/distiller/distiller2vtk.c)  (exec: o/distiller2vtk.out)
# [megamake] [project] (root: source/tracer/tracer2vtk.c)  (exec: o/tracer2vtk.out)
# [megamake] [project] (root: source/tracer/mark_trajectory.c)  (exec: o/mark_trajectory.out)
...
depend:
	...
	@megamake.pl Makefile --verbose --make:make
	@echo "Done."
...
cleanData:
	...
	@find ./tmp -type f -name "*"     | grep -v README | grep -v .svn | grep -v CVS | while read f ; do rm -f $$f ; done
	@echo "Cleaning ./output folder ..."
	@find ./output -type f -name "*"  | grep -v README | grep -v .svn | grep -v CVS | while read f ; do rm -f $$f ; done
	@echo "Cleaning ./binData folder ..."
	@find ./binData -type f -name "*" | grep -v README | grep -v .svn | grep -v CVS | while read f ; do rm -f $$f ; done
...
cleanAll: clean cleanTFSF cleanData
	...
	@find ./doc -type f -name "*" | grep -v README | while read f ; do rm -f $$f ; done
...
########################################################################
#
# This part is AUTOMATICALLY generated by '/home/henaro/bin/megamake.pl' perl script.
...
# Date: Sun Mar 13 23:00:55 KRAT 2011
...
o/setup/plasma.o: source/setup/plasma.c source/type_marker.h source/core/plasma_rho.h source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/log.h source/misc_cfgReader.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/core/em_caps.o: source/core/em_caps.c source/core/em_TFSF.h source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/scpic/em_sources.h source/type_reg.h source/scpic/em_mirror.h source/log.h source/parr_meshes.h source/misc_socket.h source/misc_MPItags.h source/parr_regLists.h source/parr_ghostCells.h source/type_mesh.h source/core/emCap_Mur.c source/core/emCap_mirror.c source/core/emCap_periodic.c source/core/emCap_decomposition.c  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/distiller/distiller2vtk.o: source/distiller/distiller2vtk.c source/log.h source/misc_cfgReader.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/core/em.o: source/core/em.c source/log.h source/profiler.h source/core/em.h source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/core/em_caps.h source/core/em_TFSF.h source/core/em_gaussSpot.h source/scpic/em_sources.h source/type_reg.h source/scpic/em_mirror.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/tracer/mark_trajectory.o: source/tracer/mark_trajectory.c source/type_marker.h source/log.h source/misc_cfgReader.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/setup/tag_TFSF.o: source/setup/tag_TFSF.c source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/core/em_TFSF.h source/setup/main.h source/log.h source/misc_units.h source/misc_cfgReader.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/setup/tag_laser.o: source/setup/tag_laser.c source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/setup/main.h source/log.h source/misc_units.h source/misc_cfgReader.h source/scpic/em_sources.h source/type_reg.h source/scpic/em_mirror.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/tracer/tracer2vtk.o: source/tracer/tracer2vtk.c source/type_marker.h source/log.h source/misc_cfgReader.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/distiller/main.o: source/distiller/main.c source/misc_units.h source/misc_cfgReader.h source/log.h source/distiller/dll.h source/type_marker.h source/IO_names.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
...
o/distiller2vtk.out: o/distiller/distiller2vtk.o o/log.o o/misc_cfgReader.o 
	@echo "  Linking $@..."
	@$(CCOMPILER) $^ -o $@ $(LFLAGS) -lm 
	@echo "  Executable $@ is ready."
	@echo ""

.PHONY: autoCleanByMegaMake_o/distiller2vtk.out
autoCleanByMegaMake_o/distiller2vtk.out:
	@echo "Removing compiled files for project o/distiller2vtk.out ..."
	@rm -f o/distiller2vtk.out o/distiller/distiller2vtk.o o/log.o o/misc_cfgReader.o

o/tracer2vtk.out: o/tracer/tracer2vtk.o o/log.o o/misc_cfgReader.o 
	@echo "  Linking $@..."
	@$(CCOMPILER) $^ -o $@ $(LFLAGS) -lm 
	@echo "  Executable $@ is ready."
	@echo ""

.PHONY: autoCleanByMegaMake_o/tracer2vtk.out
autoCleanByMegaMake_o/tracer2vtk.out:
	@echo "Removing compiled files for project o/tracer2vtk.out ..."
	@rm -f o/tracer2vtk.out o/tracer/tracer2vtk.o o/log.o o/misc_cfgReader.o

o/mark_trajectory.out: o/tracer/mark_trajectory.o o/log.o o/misc_cfgReader.o 
	@echo "  Linking $@..."
	@$(CCOMPILER) $^ -o $@ $(LFLAGS) -lm 
	@echo "  Executable $@ is ready."
	@echo ""

.PHONY: autoCleanByMegaMake_o/mark_trajectory.out
autoCleanByMegaMake_o/mark_trajectory.out:
	@echo "Removing compiled files for project o/mark_trajectory.out ..."
	@rm -f o/mark_trajectory.out o/tracer/mark_trajectory.o o/log.o o/misc_cfgReader.o
...
.PHONY: clean
clean: autoCleanByMegaMake_core.out autoCleanByMegaMake_setup.out autoCleanByMegaMake_TFSFdefrag.out autoCleanByMegaMake_math.out autoCleanByMegaMake_test_logger.out autoCleanByMegaMake_o/distiller.out autoCleanByMegaMake_o/distiller2vtk.out autoCleanByMegaMake_o/tracer2vtk.out autoCleanByMegaMake_o/mark_trajectory.out autoCleanByMegaMake_tecplot.out 


all: core.out setup.out TFSFdefrag.out math.out test_logger.out o/distiller.out o/distiller2vtk.out o/tracer2vtk.out o/mark_trajectory.out tecplot.out 
	@echo ;
	@echo "All files are compiled using '$(CCOMPILER) $(CFLAGS)'."
	@echo ;
