...
o/setup/tag_gradient.o: source/setup/tag_gradient.c source/setup/plasma.h source/type_mesh.h source/misc_partition.h source/type_reg.h source/misc_parameters.h source/frame.h source/type_marker.h source/setup/tag_plasma.h source/log.h source/misc_units.h source/misc_cfgReader.h source/misc_partition.h source/misc_parameters.h source/setup/main.h  Makefile
	@echo "Compiling $@ ..."
	@$(CCOMPILER) $(CFLAGS) $< -o $@
